...
--changeset seewis:system-postgresql-data-baseline dbms:postgresql splitStatements:false
...
insert into sys_menu values(1761400000000000121, 'AI控制台', 1761400000000000002, 7, 'http://localhost:8900/snail-ai', '', '', 'Y', 'Y', 'C', '0', '0', 'monitor:snailai:list', 'checkbox', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, 'AI控制台菜单');
...
INSERT INTO sys_menu VALUES (1761400000000011638, '请假申请', 1761400000000011616, 1, 'leave', 'workflow/leave/index', '', 'N', 'Y', 'C', '0', '0', 'workflow:leave:list', '#', '', '', 1761000000000000103, 1761100000000000001, now(), NULL, NULL, '请假申请菜单');
...
--changeset seewis:system-postgresql-soybean-menu-adaptation dbms:postgresql splitStatements:true
-- ### 管理端目录菜单
...
values (1761400000000000009, 'route.about', 0, 99, 'about', 'about/index', '', 'N', 'N', 'C', '0', '0', '', 'fluent:book-information-24-regular', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, '关于页面');
insert into sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, active_menu, ext, create_dept, create_by, create_time, update_by, update_time, remark)
...
insert into sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, active_menu, ext, create_dept, create_by, create_time, update_by, update_time, remark)
values (1761400000000000008, 'RuoYi-Plus-Soybean', 0, 100, 'https://gitee.com/xlsea/ruoyi-plus-soybean', 'FrameView', '', 'Y', 'Y', 'M', '0', '0', '', 'local-icon-gitee', '', '', 1761000000000000103, 1761100000000000001, now(), null, null, 'RuoYi-Plus-Soybean 仓库地址');
...
--changeset seewis:system-postgresql-soybean-dict-adaptation dbms:postgresql splitStatements:true
-- ### 管理端字典样式与多语言适配
...
select 1761500000000000016, '用户性别', 'sys_user_sex', 1761000000000000103, 1761100000000000001, now(), null, null, '管理端用户性别字典'
...
select 1761600000000000060, 1, 'dict.sys_user_sex.male', '0', 'sys_user_sex', '', '', 'Y', 1761000000000000103, 1761100000000000001, now(), null, null, '性别男'
where not exists (select 1 from sys_dict_data where dict_type = 'sys_user_sex' and dict_value = '0');
insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, create_dept, create_by, create_time, update_by, update_time, remark)
select 1761600000000000061, 2, 'dict.sys_user_sex.female', '1', 'sys_user_sex', '', '', 'N', 1761000000000000103, 1761100000000000001, now(), null, null, '性别女'
where not exists (select 1 from sys_dict_data where dict_type = 'sys_user_sex' and dict_value = '1');
insert into sys_dict_data (dict_code, dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default, create_dept, create_by, create_time, update_by, update_time, remark)
select 1761600000000000062, 3, 'dict.sys_user_sex.unknown', '2', 'sys_user_sex', '', '', 'N', 1761000000000000103, 1761100000000000001, now(), null, null, '性别未知'
